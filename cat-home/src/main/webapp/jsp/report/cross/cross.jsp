...
<table class="table table-striped table-condensed ">
		...
		<tr><td colspan="7" style="text-align:center"><strong>调用其他服务</strong></td></tr>
		<tr>
		...
		<c:if test="${!empty model.projectInfo.serviceProjectsInfo}">
			<tr><td colspan="7" style="text-align:center"><strong>提供服务 [ 服务器端数据 ]</strong></td>
			<c:if test="${!empty model.projectInfo.callerProjectsInfo}">
				<td></td>
				<td colspan="7" style="text-align:center"><strong>提供服务 [ 客户端数据 ]</strong></td>
			</c:if>
			</tr>
		      <tr>
		         <th class="left">Type</th>
